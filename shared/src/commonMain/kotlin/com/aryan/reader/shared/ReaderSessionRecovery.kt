...
fun BookItem.withNewerReaderSession(recovery: BookItem): BookItem {
    ...
    return copy(
        ...
        readerAutoScrollLocalMinSpeed = recovery.readerAutoScrollLocalMinSpeed,
        readerAutoScrollLocalMaxSpeed = recovery.readerAutoScrollLocalMaxSpeed,
        pdfAutoScrollIsLocal = recovery.pdfAutoScrollIsLocal,
        pdfAutoScrollLocalSpeed = recovery.pdfAutoScrollLocalSpeed,
        pdfAutoScrollLocalMinSpeed = recovery.pdfAutoScrollLocalMinSpeed,
        pdfAutoScrollLocalMaxSpeed = recovery.pdfAutoScrollLocalMaxSpeed,
