...
private const val DefaultJvmEpubPageCacheDir = "epub_page_cache"
...
class JvmSharedEpubPageCacheStorage(
    ...
    companion object {
        fun default(): JvmSharedEpubPageCacheStorage {
            ...
            return JvmSharedEpubPageCacheStorage(
                File(sharedJvmEpistemeCacheRoot(), DefaultJvmEpubPageCacheDir).apply { mkdirs() }
            )
        }
    }
}
