...
/**
 * Desktop JVM actual that keeps using the hand-written converter until the
 * platform binds md4c. Math spans are not yet extracted here; [isNative]
 * reports false so callers can surface the limitation honestly.
 */
